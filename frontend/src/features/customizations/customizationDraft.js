...
export function createCustomizationDraft(overrides = {}) {
...
export function normalizeCustomizationDraft(draft) {
  const sizeOption =
    customizationSizeOptions.find(function (option) {
      return option.sizeCategory === draft.sizeCategory;
...
function normalizeFormat(format) {
  const selectedFormat = customizationFormatOptions.find(function (option) {
