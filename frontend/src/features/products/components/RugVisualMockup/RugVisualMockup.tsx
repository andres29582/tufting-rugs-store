...
function getSvg(rug: Product): string {
  ...
  if (rug.motif === 'geometric') {
    return [
      '<svg class="rug-svg rug-svg-geometric" viewBox="0 0 720 560" role="img" aria-label="' +
        label +
        '">',
      '<defs><clipPath id="' +
        clipId +
        '"><path d="M110 96h500c28 0 50 22 50 50v286c0 28-22 50-50 50H110c-28 0-50-22-50-50V146c0-28 22-50 50-50Z"/></clipPath></defs>',
  ...
  if (rug.motif === 'organic') {
    return [
      '<svg class="rug-svg rug-svg-organic" viewBox="0 0 720 560" role="img" aria-label="' +
        label +
        '">',
      '<defs><clipPath id="' +
        clipId +
        '"><path d="M118 72c126-18 366-20 490 38 48 23 58 86 31 125-30 43-20 98 6 142 29 49-1 105-56 116-130 26-369 24-486-10-55-16-73-76-44-124 27-45 31-85 2-130-34-54 0-145 57-157Z"/></clipPath></defs>',
      '<g clip-path="url(#' + clipId + ')">',
      ...
      '<path d="M430 80c30 73 93 108 190 105v315H431c74-76 91-144 50-204-41-60-26-132 45-216Z" fill="' +
        c2 +
        '"/>',
  ...
  if (rug.motif === 'circles') {
    return [
      '<svg class="rug-svg rug-svg-circles" viewBox="0 0 720 560" role="img" aria-label="' +
        label +
        '">',
      '<defs><clipPath id="' +
        clipId +
        '"><path d="M360 502c-145 0-263-94-263-210S215 82 360 82s263 94 263 210-118 210-263 210Z"/></clipPath></defs>',
      '<g clip-path="url(#' + clipId + ')">',
  ...
  if (rug.motif === 'arches') {
    return [
      '<svg class="rug-svg rug-svg-arches" viewBox="0 0 720 560" role="img" aria-label="' +
        label +
        '">',
      '<defs><clipPath id="' +
        clipId +
        '"><path d="M128 64h464c30 0 54 24 54 54v324c0 30-24 54-54 54H128c-30 0-54-24-54-54V118c0-30 24-54 54-54Z"/></clipPath></defs>',
      '<g clip-path="url(#' + clipId + ')">',
      '<rect width="720" height="560" fill="' + c2 + '"/>',
      '<path d="M152 476V213c0-82 66-148 148-148s148 66 148 148v263h-44V214c0-58-47-105-105-105s-105 47-105 105v262Z" fill="' +
        c1 +
        '"/>',
      '<path d="M238 476V234c0-35 28-63 63-63s63 28 63 63v242h-41V234c0-12-10-22-22-22s-22 10-22 22v242Z" fill="' +
        c2 +
        '"/>',
  ...
  if (rug.motif === 'soft') {
    return [
      '<svg class="rug-svg rug-svg-soft" viewBox="0 0 720 560" role="img" aria-label="' +
        label +
        '">',
      '<defs><clipPath id="' +
        clipId +
        '"><path d="M124 136c78-79 229-87 341-61 105 24 195 94 186 202-9 109-118 177-244 194-130 18-279-20-338-107-51-76-16-158 55-228Z"/></clipPath></defs>',
      '<g clip-path="url(#' + clipId + ')">',
      '<rect width="720" height="560" fill="' + c2 + '"/>',
  ...
  return [
    '<svg class="rug-svg rug-svg-waves" viewBox="0 0 720 560" role="img" aria-label="' +
      label +
      '">',
    '<defs><clipPath id="' +
      clipId +
      '"><path d="M121 143c97-95 278-92 413-35 90 38 147 107 128 189-20 85-110 148-212 176-124 34-275 20-360-47-82-65-52-205 31-283Z"/></clipPath></defs>',
    '<g clip-path="url(#' + clipId + ')">',
    ...
    '<path d="M305 64c105 47 152 113 140 199-13 91 31 153 131 186l-77 83c-119-45-170-120-152-225 15-88-32-146-139-174Z" fill="' +
      c1 +
      '"/>',
    '<path d="M470 55c-66 90-66 164 2 221 67 56 65 130-7 223l166 8c77-94 78-172 4-235-73-63-70-135 9-217Z" fill="' +
      c2 +
      '"/>',
    '<path d="M242 346c30-63 76-79 139-49 58 28 84 9 77-56 73 67 68 140-14 219-80 4-147-34-202-114Z" fill="' +
      c3 +
      '"/>',
